          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Hi! I'm the creator behind djkwnebhdwbd. What started as a
                ...
                <p>
                  ...
                  with the world, I decided to take the leap. djkwnebhdwbd is my
                  way of bringing handmade, thoughtful creations to people who
                ...
                <p className="text-amber-700 font-medium italic">
                  ...
                  love and dedication. When you buy from djkwnebhdwbd, you're
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-amber-500">
              ...
              <p className="text-gray-600 leading-relaxed">
                To grow djkwnebhdwbd into a trusted brand known for unique,
        ...
        <div className="mb-20">
          <div className="bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200 rounded-xl p-8">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      ...
                      support and encouragement, djkwnebhdwbd can grow into
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      ...
                      When you buy from djkwnebhdwbd, you're not just getting a
            ...
            <div className="mt-8 text-center">
              ...
              <p className="text-gray-600 mt-2">— djkwnebhdwbd Founder</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <p className="text-gray-600">hello@djkwnebhdwbd.in</p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">@djkwnebhdwbd on Instagram</p>
            </div>
          </div>
